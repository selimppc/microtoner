            ...
            <tbody>
            	...
            	<?php foreach ($page_q->result() as $page): ?>
            		<tr data-page-row="<?php echo $page->user_id; ?>">
            			...
            			<td>
            				<a class="btn btn-primary" href="" data-toggle="modal" data-target="#myModal<?php echo $page->invoice_id; ?>">Details</a>
		            			<div style="width: 60%;left: 40%;" class="modal fade" id="myModal<?php echo $page->invoice_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
									        	...
									        	<tbody>
									        		...
									        		<?php
							            				...
							            				$product_request =     
										                    ...
										                    WHERE product_request.invoice_id = {$page->invoice_id} && (product_request.status !=1 || product_request.status !=3)";
									        			...
									        			<td>
									        				<?php
									        					...
									        					if(!empty($user_data->shipping_firstname)):	
									        						...
									        						echo '<br/>';
echo 'Company Name : '.$user_data->shipping_company_name;
									        						echo '<br/>';
            				...
            				<a data-page-id="<?php echo $page->user_id; ?>" class="btn btn-primary shipped_request" href="">Shipped</a>
