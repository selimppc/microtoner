            ...
            <tbody>
            	...
            	<?php foreach ($page_q->result() as $page): ?>
            		<tr data-page-row="<?php echo $page->user_id; ?>">
            			...
            			<!-- <td><?php //echo $page->invoice_id; ?></td> -->
            			<td>
									        	...
									        	<tbody>
									        		...
									        		<?php
							            				...
							            				$product_request =     
										                    ...
										                    WHERE product_request.user_id = {$page->user_id} && product_request.status=1";
...
echo 'Company Name : '.$user_data->shipping_company_name;
            				...
            				<a data-page-id="<?php echo $page->user_id; ?>" class="btn btn-primary archive_request" href="">Archieve</a>
