					...
					<div class="row">
						<div class="subcategory_section">
							<div class="subcategory_first">
								...
								<div class="subcategory_container subcategory_for_printer">
									<div class="subcategory_box">
										<?php foreach($get_child_id_r->result() as $get_child_id): ?>
												<?php 
													$printer_list_r = $this->common_m->sub_menu_printer_list($get_child_id->page_slug);	
													foreach($printer_list_r->result() as $printer_list):
												?>
												
													<div class="subcategory"><a class="for_printer" href="<?php echo base_url(); ?><?php echo $get_child_id->page_slug; ?>/<?php echo $printer_list->printer_slug; ?>"><?php echo $printer_list->printer_name; ?></a></div>
							...
							<div class="subcategory_second">
								<span class="first_tab">Product Number</span>
								<div class="subcategory_container">
									<?php 
										$main_product_r = $this->common_m->sub_menu($page_data->id);
										foreach($main_product_r->result() as $main_product):
											$first_sub_product_r = $this->common_m->sub_menu($main_product->page_id);
											foreach($first_sub_product_r->result() as $first_sub_product):
									?>
												<div class="subcategory_box">
													<h2><?php echo $first_sub_product->title; ?></h2>
													<?php
														$show_printer_r = $this->common_m->sub_menu($first_sub_product->page_id);
